...
const WEB_XPATH:&[&[&str]] = &[
     //No.,FieldName,xpath
     &["1","agree","/html/body/div[2]/div/div/div/div[2]/div/button[3]"],
     &["2","screener","/html/body/table[2]/tbody/tr/td/table/tbody/tr/td[3]/a"],
     &["3","screener all view","/html/body/div[3]/table/tbody/tr[2]/td/div/div[2]/div[6]"],
     &["4","select exchange","/html/body/div[3]/table/tbody/tr[3]/td/div/form/table/tbody/tr[1]/td[2]/select/option[3]"],
     &["5","select Market Cap","/html/body/div[3]/table/tbody/tr[3]/td/div/form/table/tbody/tr[1]/td[2]/select/option[3]"],
     &["6","select Option/Short","/html/body/div[3]/table/tbody/tr[3]/td/div/form/table/tbody/tr[8]/td[10]/select/option[2]"],
     &["7","200-Day Simple Moving Average","/html/body/div[3]/table/tbody/tr[3]/td/div/form/table/tbody/tr[10]/td[8]/select/option[12]"],
     &["8","sma_over_50_xpath","/html/body/div[3]/table/tbody/tr[3]/td/div/form/table/tbody/tr[10]/td[6]/select/option[8]"],
     &["9","sma_over_20_xpath","/html/body/div[3]/table/tbody/tr[3]/td/div/form/table/tbody/tr[10]/td[4]/select/option[8]"],
     &["10","price_xpath","/html/body/div[3]/table/tbody/tr[3]/td/div/form/table/tbody/tr[13]/td[8]/select/option[40]"],
     &["11","pattern_xpath","/html/body/div[3]/table/tbody/tr[3]/td/div/form/table/tbody/tr[13]/td[8]/select/option[40]"],
     &["12","peg_over_one_xpath","/html/body/div[3]/table/tbody/tr[3]/td/div/form/table/tbody/tr[2]/td[8]/select/option[7]"],
     &["13","eps_year_xpath","/html/body/div[3]/table/tbody/tr[3]/td/div/form/table/tbody/tr[3]/td[8]/select/option[3]"],
     &["14","eps_qtr_xpath","/html/body/div[3]/table/tbody/tr[3]/td/div/form/table/tbody/tr[4]/td[8]/select/option[3]"],
     &["15","peg_xpath","/html/body/div[3]/table/tbody/tr[3]/td/div/form/table/tbody/tr[2]/td[8]/select/option[7]"],
     &["16","beta_xpath","/html/body/div[3]/table/tbody/tr[3]/td/div/form/table/tbody/tr[12]/td[6]/select/option[7]"],
    ];

    // /html/body/div[4]/table/tbody/tr[3]/td/div/form/table/tbody/tr[13]/td[8]/select/option[40]
